...
namespace Square.Infrastructure.Persistence.QueryMigrations
{
    ...
    public partial class QueryInit : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "column_images", schema: "query");

            migrationBuilder.DropTable(name: "topic_subscribes", schema: "query");

            migrationBuilder.DropTable(name: "columns", schema: "query");

            migrationBuilder.DropTable(name: "topics", schema: "query");
        }
    }
}
