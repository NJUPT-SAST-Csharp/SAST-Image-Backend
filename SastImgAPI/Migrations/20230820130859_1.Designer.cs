...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SastImgAPI.Models.DbSet.Classification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SastImgAPI.Models.DbSet.Image", b =>
                {
                    ...
                    b.HasIndex("ClassificationId")
                        .HasDatabaseName("ix_images_classification_id");

                    b.HasIndex("FromId")
                        .HasDatabaseName("ix_images_from_id");

                    b.HasIndex("TagId")
                        .HasDatabaseName("ix_images_tag_id");
            ...
            modelBuilder.Entity("SastImgAPI.Models.Identity.User", b =>
                {
                    ...
                    b.Property<bool>("IsNewsFeedEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("is_news_feed_enabled");
            ...
            modelBuilder.Entity("SastImgAPI.Models.DbSet.Image", b =>
                {
                    ...
                    b.HasOne("SastImgAPI.Models.DbSet.Classification", "Classification")
                        .WithMany("Images")
                        .HasForeignKey("ClassificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_images_classifications_classification_id");
                    ...
                    b.HasOne("SastImgAPI.Models.DbSet.Tag", null)
                        .WithMany("Images")
                        .HasForeignKey("TagId")
                        .HasConstraintName("fk_images_tags_tag_id");
